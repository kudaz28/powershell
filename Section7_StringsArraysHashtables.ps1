...
"I can't believe how awesome Powershell is!"
...
$hash."Linux Academy"    # Get single value using object syntax
...
$hash["A Cloud Guru"] = "acloud.guru"  # Add value using new key
$hash                                     # Show the additional row

$hash.Remove("Linux Academy")        # Remove by passing in key
$hash

# See if key exists
$hash.Contains("A Cloud Guru")      # Should be there
$hash.Contains("Linux Academy")      # Gone since we just removed it

# See if value exists
$hash.ContainsValue("PowerShell.com")  # Will be there
$hash.ContainsValue("linuxacademy.com")  # Not there since it was removed
